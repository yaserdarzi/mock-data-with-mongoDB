...
class DetailAccountTypeController extends ApiController
{
    ...
    {
        return $this->respond(DB::connection('mongodb')->collection('detailAccountType')->get());
    }
    ...
    {
        DB::connection('mongodb')->collection('detailAccountType')->where('code', $id)->delete();
        return $this->respond('');
    }
